...
**[Retail Sales & Inventory Performance Analysis](https://github.com/maitruong-data/Retail-Sales-Inventory-Performance-Analysis-SQL-BigQuery)**
Analyzed 230K+ retail sales, inventory, and operations records in SQL/BigQuery to uncover growth, retention, stock efficiency, and pending order insights.
...
**[Fashion Marketing & Sales Analysis](https://github.com/maitruong-data/Fashion-Marketing-and-Sales-Analysis-Power-BI)**
Analyzed 10K+ records from marketing campaigns and sales orders to evaluate campaign efficiency, product performance, and revenue drivers.
...
Analyzed 6M+ records from 5 data sources (Shopify, WooCommerce, Sapo, banking, and marketing) to evaluate customer behavior, cashflow health, and payment risk. An end-to-end Python ETL (GCS → BigQuery).

---

## 🚧 Work In Progress

**Sansaino Marketing Data Pipeline**
